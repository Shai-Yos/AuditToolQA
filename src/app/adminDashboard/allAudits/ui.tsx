...
export default function AllAuditsClient({
  user,
  audits,
  userRole = "USER",
}: {
  ...
  // Smart polling: refresh when any audit changes or an audit is deleted.
        ...
        <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1.5 text-sm text-slate-600">
              Browse, filter, and manage all audits across every status.
            </p>
          </div>
