          ...
          <div className="mb-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              <select
                ...
                className="rounded-lg border border-slate-200 bg-slate-50 px-2 py-1 text-sm font-bold text-slate-900 outline-none cursor-pointer hover:bg-white focus:border-blue-400"
              >
