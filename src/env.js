...
export const env = createEnv({
  ...
  server: {
    ...
    AZURE_AD_SEARCH_CLIENT_ID: z.string().optional(),
    AZURE_AD_SEARCH_CLIENT_SECRET: z.string().optional(),
    AZURE_AD_SEARCH_TENANT_ID: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    AZURE_AD_SEARCH_CLIENT_ID: process.env.AZURE_AD_SEARCH_CLIENT_ID,
    AZURE_AD_SEARCH_CLIENT_SECRET: process.env.AZURE_AD_SEARCH_CLIENT_SECRET,
    AZURE_AD_SEARCH_TENANT_ID: process.env.AZURE_AD_SEARCH_TENANT_ID,
