...
export default function RequestUI({
  ...
  const dashboardBase = pathname.split("/").filter(Boolean)[0] || "userDashboard";
  ...
  const forceUnlockAndExit = async () => {
    ...
    try {
      ...
      router.replace(`/${dashboardBase}/audits/${auditId}/requests`);
    } catch {
  ...
  return (
    <main className="min-h-screen bg-slate-50 print:bg-white print:min-h-0">
      ...
      <style dangerouslySetInnerHTML={{ __html: `@media print { html, body { height: auto !important; min-height: 0 !important; background: white !important; } @page { size: A4 portrait; margin: 2cm 1.5cm 2.5cm 1.5cm; @bottom-right { content: "Page " counter(page) " of " counter(pages); font-family: system-ui, sans-serif; font-size: 9pt; color: #64748b; font-weight: 600; padding-right: 0.5cm; } } * { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; } }` }} />
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                ...
                <div className="inline-flex items-center rounded-full border border-dashed border-slate-300 transition focus-within:border-blue-400">
                  ...
                  <button
                    ...
                    className="pr-2.5 pl-1 py-1.5 text-slate-400 hover:text-blue-600 transition font-bold text-base leading-none disabled:cursor-not-allowed"
                  >
                    +
                  </button>
                </div>
