    ...
    >
      ...
      >
        ...
        <nav className="flex flex-1 flex-col overflow-y-auto px-2 py-4">
          ...
          />
          <NavItem
            href="/userDashboard/miscellaneous"
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            label="Miscellaneous"
            active={pathname.startsWith("/userDashboard/miscellaneous")}
            collapsed={sidebarCollapsed}
            newTab
          />
          {canAccessRegulatoryImplementation && (
            <NavItem
              href="/userDashboard/regulatoryImplementation"
              icon={
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              active={pathname.startsWith("/userDashboard/regulatoryImplementation")}
              collapsed={sidebarCollapsed}
              newTab
            />
          )}
