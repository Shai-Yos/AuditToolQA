    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <div className="relative mx-auto w-full max-w-none px-4 sm:px-6 xl:px-10 py-8">
        ...
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-center">
          ...
          <div className="inline-flex items-center justify-center gap-1 rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-slate-600">
            Assigned To
